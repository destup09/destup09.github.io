  ...
  function createNewObject(e) {
    ...
    if (create.className !== "create-indicator") {
      ...
      function moveDiv() {
        ...
        movableObject.addEventListener(
          "mousedown",
          function(e) {
            console.log(this);
            isDown = true;
            offset = [
              movableObject.offsetLeft - e.clientX,
              movableObject.offsetTop - e.clientY
            ];
            isOut = false;
            OutDirection = 0;
          },
            ...
            if (isDown) {
              if (!isResizing) {
                if (!isOut) {
                  ...
                  movableObject.style.left = mousePosition.x + offset[0] + "px";
                  movableObject.style.top = mousePosition.y + offset[1] + "px";
                }
              }
            }
          },
